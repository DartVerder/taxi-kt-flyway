...
INSERT INTO driver (id, first_name, last_name, date_of_birth, rating, drivers_license, card_id)
VALUES (1, 'Ivan', 'Ivanov', '1970-02-01', 4.9, '123123', 1);

INSERT INTO driver (id, first_name, last_name, date_of_birth, drivers_license, card_id)
VALUES (2, 'Petr', 'Petrov', '1995-06-16', '123124', 2);
...
INSERT INTO car (id, colour, production_date, comfort_class, license_plate, driver_id, car_model_id)
VALUES (1, 'red', NOW(), 0, 'A123BC163', 1, 1);

INSERT INTO car (id, colour, production_date, comfort_class, license_plate, driver_id, car_model_id)
VALUES (2, 'black', '2021-01-01', 2, 'A444BC163', 2, 2);

INSERT INTO address (id, house_number, entrance, city, street)
VALUES (1, '2', 1, 'Samara', 'Kuybisheva');

INSERT INTO address (id, house_number, entrance, city, street)
VALUES (2, '32', 2, 'Samara', 'Venceka');

INSERT INTO address (id, house_number, city, street)
VALUES (3, '1', 'Samara', 'Tashkentskaya');

INSERT INTO address (id, house_number, city, street)
VALUES (4, '55', 'Samara', 'Kuybisheva');
...
INSERT INTO trip_addresses (id, order_in_trip, address_id, trip_id)
VALUES (1, 0, 1, 1);
